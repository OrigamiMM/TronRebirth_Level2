...
public class TronPanel extends JPanel implements ActionListener, KeyListener {
	...
	void updateEndState() {
		...
		if (Player1.isAlive == false) {
			...
			manager1.reset();
			Player1 = new TronPlayer1(20, 20, 150, 400, 4, 1);
			manager1.addObject(Player1);
			manager2.reset();
			Player2 = new TronPlayer1(20, 20, 650, 400, 4, 2);
			manager2.addObject(Player2);
		}
	...
	void drawEndState(Graphics g) {
		...
		if (Player2.CD1 == Player2.left1) {
			x2 = Player2.x + 20;
			y2 = Player2.y + 5;
		}
		if (Player2.CD1 == Player2.right1) {
			x2 = Player2.x - 10;
			y2 = Player2.y + 5;
		}
		Trail trail1 = new Trail(x1, y1, 10, 10, 1);
		Trail trail2 = new Trail(x2, y2, 10, 10, 2);
